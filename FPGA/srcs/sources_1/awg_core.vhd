...
--					  dac_data_1	<= dac_data_1_test;
					...
					if	unsigned(generatorType_1d) = 0 then
						...
						if q_gen_1(0)	= '0' then
							...
							ram_addrb_awg_1 <= std_logic_vector(to_signed(-16384,bH+1)+signed(kot_gen_1(bH downto 0)));
						end if;
						enable_rand_1	<= '0';
...
--					  dac_data_2	<= dac_data_2_test;
					...
					if	unsigned(generatorType_2d) = 0 then
						...
						if q_gen_2(0)	= '0' then
							...
							ram_addrb_awg_2 <= std_logic_vector(to_signed(-16384,bH+1)+signed(kot_gen_2(bH downto 0)));
						end if;
